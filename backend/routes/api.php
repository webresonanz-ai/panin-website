...
$router->post('/api/wasender/send-document', [WasenderController::class, 'sendDocument']);
...
$router->post('/api/guests/{id}/send-invitation', [GuestController::class, 'sendInvitation']);
